...
await db.execute(`INSERT INTO WalkApplications (dog_id, requested_time, duration_minutes, location, status) VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Bella'), '2025-05-19 09:00:00' , 60, 'Beachside Ave', 'completed');`);



await db.execute(`INSERT INTO WalkRatings (request_id, owner_id, walker_id, rating) VALUES (5, 3, 2, 3);`);
